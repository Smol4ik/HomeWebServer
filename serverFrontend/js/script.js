/*const btnGet = document.getElementById('get-id')
const btnPost = document.getElementById('post-data')
const btnPut = document.getElementById('put-data')
...
//const areaForData = document.getElementById('input-for-data')
//const areaForId = document.getElementById('input-for-id')
